...
make_overall  = 'CREATE TABLE Overall(year INTEGER'
make_stranded = 'CREATE TABLE Stranded(year INTEGER'
make_word     = 'CREATE TABLE Words(year INTEGER, Total INTEGER); '
...
make_overall  = make_overall + '); '
make_stranded = make_stranded + '); '
...
overall_script  = 'DROP TABLE IF EXISTS Overall; ' + make_overall
stranded_script = 'DROP TABLE IF EXISTS Stranded; ' + make_stranded
word_script     = 'DROP TABLE IF EXISTS Words; ' + make_word

#Make a line in the script for every year.
for year in range(1000, 2014):

	word_script     = word_script + 'INSERT INTO Words VALUES(' + str(year) + ', 0); '
	overall_script  = overall_script + 'INSERT INTO Overall VALUES(' + str(year)
	stranded_script = stranded_script + 'INSERT INTO Stranded VALUES(' + str(year)
	...
	stranded_script = stranded_script + '); '
